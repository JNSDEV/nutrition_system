...
- [x] **DOC-02**: User can read a `docs/conventions.md` describing file-naming (e.g. `daily/2026-05-05.md`, `weekly/2026-W19.md`), date format, and how partner's display name is resolved (placeholder "Partner" — overridable).
