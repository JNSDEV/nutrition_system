...
**Plans**: 5 plans
- [x] 04-01-readme-PLAN.md — Create top-level README.md with 7 locked sections (D-03 order): loop diagram, what-is-this, quickstart week, commands table, mobile-buffer example, folder tree, where-to-look-next
