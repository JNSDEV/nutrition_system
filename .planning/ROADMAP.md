...
- [ ] **Phase 2: Trackers & Baselines** - Scaffold per-person trackers with seeded baselines, enable calendar-driven daily target resolution
...
**Success Criteria** (what must be TRUE):
  ...
  2. User can open `trackers/partner/progress.md` and see starting weight 58 kg and target 53 kg
